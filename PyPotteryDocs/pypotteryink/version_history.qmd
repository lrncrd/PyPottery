...
-   **Batch Processing** has an **Open Output Folder** button, like the diagnostics, and the previews of a large selection of images stay smooth: small thumbnails decoded a few at a time, at most 60 tiles (the rest is counted as "+N more") and removal of a single image without reloading the others
