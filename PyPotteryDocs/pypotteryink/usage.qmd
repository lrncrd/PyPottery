...
At the end of the process, a gallery will allow you to view the results. Click any comparison image to open it fullscreen for a closer look.

::: {.callout-note}
The first time you run a diagnostic or batch process, PyPotteryInk needs to download the required models (the small style model and, once, the ~5GB diffusion backbone). A progress overlay shows live download status so the app doesn't appear stuck.
:::
...
The results will be shown in a gallery. Click any comparison image to open it fullscreen for a closer look.
